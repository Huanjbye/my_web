...
<head>
    ...
    <link rel="stylesheet" href="../../public/CSS/trang_login.css">
...
<body>
    <div class="login">
        ...
        <div class="container">
            <form class="frmlogin" onsubmit="login()">
                <div class="dangnhap">
                    <h2>Đăng nhập</h2>
                </div>
                <div class="phone-number">
                    <input type="text" id="name" class="phone-number__items" placeholder="Email/Số điện thoại/Tên đăng nhập">
                ...
                <div class="phone_password">
                    <input type="password" id="password" class="phone-password__items" placeholder="Mật khẩu">
                ...
                <button class="button-dangnhap">Đăng nhập</button>
                <div class="support">
                    <a class="forget-password" href="#">Quên mật khẩu
                    </a>
                ...
                <div class="frm_register">
                    <div class="want-know">
                        <a href="#">Bạn muốn biết đến F.one?</a>
                    </div>
                    <div class="link-register">
                        <a href="trang_singup.php">Đăng ký</a>
                    </div>
                </div>
            </form>
        </div>
